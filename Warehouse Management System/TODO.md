...
- [ ] Nachbestellungen List is cutting on 04.03.2026 even we have 2 weeks after it on the sheet. checking why this happens and fixing it. We can search all of them as stock and it gets found even it was not showing on the list, but it should show all of the open ones on the list based on latest entry from top to bottom.
- [ ] .
