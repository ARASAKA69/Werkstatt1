...
* **waffensicherung & not-aus:** doppelklicks auf alt+y sind gesperrt damit das script nicht doppelt losrennt und sich aufhängt. falls ihr es mal aus versehen beim falschen auftrag startet, drückt einfach `ESC` auf der tastatur und er bricht sofort ab.
* **speed einstellungen:** falls euer pc oder inet mal wieder mega lahm ist, könnt ihr oben rechts im chrome auf das tampermonkey icon klicken und die geschwindigkeit für euch selber auf "LANGSAM" oder "SEHR LANGSAM" stellen.

## installation - so kriegt ihr es:

1. ladet euch die erweiterung **Tampermonkey** für Google Chrome runter.
2. klickt einfach auf diesen link hier: 
   👉 [ARASAKA Installieren](https://github.com/ARASAKA69/Werkstatt1/raw/refs/heads/main/arasaka-automation.user.js)
3. es öffnet sich ein neuer tab, da einfach auf **Installieren** (oder Update) klicken.
4. fertig. 
